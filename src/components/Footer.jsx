    ...
    <footer className="relative py-16 px-6 bg-black overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span className="block w-8 h-px bg-cream/10" />
          <span className="block w-1 h-1 rounded-full bg-cream/15" />
          <span className="block w-8 h-px bg-cream/10" />
        </div>

        <p className="font-body text-cream/20 text-xs tracking-[4px] uppercase text-center">
          Farm · Deli · Distillery · Garden Route
        </p>
        ...
        <div className="flex gap-5">
          <a
            ...
            className="text-cream/15 hover:text-gold/60 transition-colors duration-300"
            aria-label="Facebook"
          >
        ...
        <p className="font-body text-cream/10 text-[10px] tracking-wider">
          &copy; {new Date().getFullYear()} Misty Valley Farm. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
